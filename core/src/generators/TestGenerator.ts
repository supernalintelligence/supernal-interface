...
export class TestGenerator {
  ...
  static generatePlaywrightTests(
    ...
    const uiTools = tools.filter(t => t.executionContext === 'ui' || t.executionContext === 'both');
   ...
   */
  private static generateTestHeader(className: string, testType: string, framework: string): string {
