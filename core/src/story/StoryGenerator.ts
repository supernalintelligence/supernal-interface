...
export async function executeAutoGeneratedStory(
  ...
  console.log(\`🎭 Executing auto-generated story: "\${storyName}"\`);
  ...
  try {
    ...
    console.log(\`✅ Story "\${storyName}" completed successfully\`);
    return { success: true, message: \`Story "\${storyName}" executed successfully\` };
    
  } catch (error) {
    const errorMessage = error instanceof Error ? error.message : String(error);
    console.error(\`❌ Story "\${storyName}" failed: \${errorMessage}\`);
