...
export const COMMON_STORY_TEMPLATES: StoryTemplate[] = [
  ...
  // Basic interaction stories
  {
    ...
    stepTemplates: [
      { actionPattern: '*ChatInput', params: ['Hello world!'], description: 'Type message in chat input' },
...

  {
    ...
    stepTemplates: [
      ...
      { actionPattern: 'verify:*Input*', description: 'Verify input is focused', validation: 'verifyInputFocused' }
    ]
  },
  ...
  // Workspace/container management
  {
    ...
    stepTemplates: [
      ...
      { actionPattern: 'type:*Name*', params: ['Test Container'], description: 'Enter container name' },
  ...
  // Persistence stories
  {
    ...
    stepTemplates: [
      { actionPattern: 'type:*Input*', params: ['Test persistence'], description: 'Enter test data' },
...
export const SUPERNAL_STORY_TEMPLATES: StoryTemplate[] = [
  
  {
    ...
    stepTemplates: [
      { actionPattern: 'typeChatInput', params: ['Hello world!'], description: 'Type hello message' },
...

  {
    ...
    stepTemplates: [
      ...
      { actionPattern: 'typeWorkspaceNameInput', params: ['Development'], description: 'Enter workspace name' },
...

  {
    ...
    stepTemplates: [
      ...
      { actionPattern: 'verify:*Focus*', description: 'Verify chat input focused', validation: 'verifyChatInputFocused' }
    ]
  },

  {
    ...
    stepTemplates: [
      ...
      { actionPattern: 'typeChatInput', params: ['Message with context'], description: 'Type message' },
